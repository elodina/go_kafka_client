...
func main() {
    ...
    go consumer.StartStatic(map[string]int {*consumeTopic : 2})
...
func avroStrategy(_ *kafka.Worker, msg *kafka.Message, id kafka.TaskId) kafka.WorkerResult {
    ...
    messageTimings = append(messageTimings, msg.DecodedKey)
...
func protoStrategy(_ *kafka.Worker, msg *kafka.Message, id kafka.TaskId) kafka.WorkerResult {
    line := &sp.LogLine{}
