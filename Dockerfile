...
ENV KAFKA_URL https://people.apache.org/~junrao/kafka-0.8.2.1-candidate2/$KAFKA_RELEASE.tgz #https://archive.apache.org/dist/kafka/$KAFKA_VERSION/$KAFKA_RELEASE.tgz
